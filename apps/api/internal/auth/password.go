...
// Argon2id parametreleri (OWASP 2024 önerisi, dengeli)
...
// HashPassword — argon2id ile, encoded string döner: $argon2id$v=19$m=...,t=...,p=...$salt$hash
...
func VerifyPassword(password, encoded string) (bool, error) {
	...
	if parts[1] != "argon2id" {
		return false, errors.New("auth: unsupported algorithm")
	}
	var version int
